...
<main>
    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            ...
            <div class="row justify-content-center form-bg-image" data-background-lg="{{ asset('backend/assets') }}/assets/img/illustrations/signin.svg">
                        ...
                        <form action="{{ route('login')}}" method="POST" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email"class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="example@company.com" id="email" autofocus required>
