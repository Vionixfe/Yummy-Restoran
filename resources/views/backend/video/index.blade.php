                    ...
                    <tbody>
                        @foreach ($videos as $item)
                            <tr>
                                ...
                                <td width="20%">
                                    <a href="{{ route('panel.video.show', $item->uuid) }}">
                                        <img src="https://img.youtube.com/vi/{{ $item->link }}/0.jpg" class="img-thumbnail" width="200" height="150">
                                    </a>
                                        <td>
                                    <div class="btn-group">
                                        <a href="{{ route('panel.video.show', $item->uuid) }}"
